        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(text1.equals("") || text2.equals("")) {
                    ...
                    Toast.makeText(PasswordCreate.this, "Please enter the password", Toast.LENGTH_SHORT).show();
                    ...
                    if(text1.equals(text2)){
                        ...
                        Toast.makeText(PasswordCreate.this, "Password doesn't match", Toast.LENGTH_SHORT).show();
